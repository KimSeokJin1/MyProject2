...
//вызов диалогового окна в начале игры
        ...
        dialogfonEnd.setBackgroundResource(R.drawable.dialogend3);
        ...
        textdescriptionEnd.setText(R.string.Level_treeEnd);
        //Интересный факт - конец

        //Копка которая закрывает диалоговое окно-начало
        TextView btn_close3= (TextView)dialogEnd.findViewById(R.id.btn_close);
        ...
        Button button_continue3 =(Button) dialogEnd.findViewById(R.id.btn_continue);
...
//вызов диалогового окна в  игры
        ...
        //Кнопка Назад -начало
        Button button3_back= (Button)findViewById(R.id.button2_back);
        button3_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
