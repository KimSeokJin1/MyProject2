...
public class Level4 extends AppCompatActivity {
   ...
   public int count=0;//счетчик правильных ответов
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setText(R.string.level_four);
       ...
       //код который скругляет углы
        ...
        background.setImageResource(R.drawable.main_backround4);
        ...
        dialogfonEnd.setBackgroundResource(R.drawable.previewbackroundone);
        ...
        textdescriptionEnd.setText(R.string.Level_fourEnd);
        //Интересный факт - конец

        //Копка которая закрывает диалоговое окно-начало
        TextView btn_close4= (TextView)dialogEnd.findViewById(R.id.btn_close);
        btn_close4.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        //Кнопка Назад -начало
        Button button4_back= (Button)findViewById(R.id.button2_back);
        button4_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        final Animation a= AnimationUtils.loadAnimation(Level4.this, R.anim.alpha);//Теперь через переменную а можно обратиться к файлу с анимацией и анимация будет загружена в java
